  ...
  <li key="" className="sm:py-8">
    <div className="space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0">
      <div className="aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4">
        <img className="object-cover shadow-lg rounded-lg" src="" alt="" />
      </div>
...
<div className="relative px-4 sm:px-6 lg:px-8">
  ...
  <div className="text-lg mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto max-w-prose pt-10 border-solid border-t-2">
    <p>
      ...
      turpis id. Id dolor praesent donec est. Odio penatibus risus viverra
    ...
    <p>
      ...
      Donec commodo sit viverra aliquam porttitor ultrices gravida eu. Tincidunt
      leo, elementum mattis elementum ut nisl, justo, amet, mattis. Nunc purus,
    ...
    <p>
      ...
      mauris, ultrices mauris. Tincidunt enim cursus ridiculus mi. Pellentesque
      nam sed nullam sed diam turpis ipsum eu a sed convallis diam.
    </p>
    <blockquote>
      <p>
